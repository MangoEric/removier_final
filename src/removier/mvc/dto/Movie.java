...
//    List<Actor> actorList = new ArrayList<>();
    ...
    public Movie(int movie_pk, String mov_title, String mov_genre, String mov_plot, String mov_date, String mov_director, String actor_name1, String actor_name2, String actor_name3, String actor_name4, List<Review> reviewList) {
        this.movie_pk = movie_pk;
        this.mov_title = mov_title;
        this.mov_genre = mov_genre;
        this.mov_plot = mov_plot;
